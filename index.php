...
<html lang="en">
  ...
  <head>
    ...
    <title>Villa ErikPunya - Refreshing</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8">
          <ul class="info">
            <li><i class="fa fa-envelope"></i> erikmarga25@gmail.com</li>
            <li><i class="fa fa-map"></i> Pasirwangi, 93201, Penginapan Erik Project</li>
          </ul>
        </div>
    ...
    <div class="owl-carousel owl-banner">
      <div class="item item-1">
        <div class="header-text">
          <span class="category">Garut, <em>Jawa Barat, Indonesia</em></span>
          <h2>Buru-buru!<br>Dapatkan Villa Terbaik untuk Anda</h2>
        </div>
      </div>
      <div class="item item-2">
        <div class="header-text">
          <span class="category">Taman Pujaan Bangsa, <em>Bali, Indonesia</em></span>
          <h2>Jadilah Cepat!<br>Dapatkan vila terbaik di kota bali</h2>
        </div>
      </div>
      <div class="item item-3">
        <div class="header-text">
          <span class="category">Bandung, <em>Dago, Indonesia</em></span>
          <h2>Bergerak Sekarang!<br>Dapatkan penthouse tingkat tertinggi</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="section-heading">
            <h6>| Unggulan</h6>
            <h2> Apartemen Terbaik &amp; Pemandangan laut</h2>
          </div>
          <div class="accordion" id="accordionExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                Tautan bermanfaat terbaik?
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <strong>Vila Terbaik.</strong> Keluar rumah tengoklah langit. Bulan yang suka diributkan di bumi itu tenang-tenang saja di atas sana. <a href="https://www.google.com/search?q=best+free+css+templates" target="_blank">Cepaaatttttt!!!</a> Beri tahu teman Anda tentang rik_project </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  Dukaa <strong>almesit amet</strong>, Demikian pula, tidak adakah orang yang mencintai atau mengejar atau ingin mengalami penderitaan, bukan semata mata karena penderitaan itu sendiri.<code>adipiscing</code> Demikian pula, tidak adakah orang yang mencintai atau mengejar atau ingin mengalami penderitaan, bukan semata mata karena penderitaan itu sendiri.
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingThree">
                ...
                Mengapa Villa Agensi adalah yang terbaik?
                </button>
              </h2>
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  Nyeri<strong>almesit amet</strong>, Demikian pula, tidak adakah orang yang mencintai atau mengejar atau ingin mengalami penderitaan, bukan semata mata karena penderitaan itu sendiri. <code>adipiscing</code> Demikian pula, tidak adakah orang yang mencintai atau mengejar atau ingin mengalami penderitaan, bukan semata mata karena penderitaan itu sendiri.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="info-table">
            <ul>
              <li>
                ...
                <h4>250 m2<br><span>Total Ruang Datar</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-02.png" alt="" style="max-width: 52px;">
                <h4>Kontrak<br><span>Kontrak Siap</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-03.png" alt="" style="max-width: 52px;">
                <h4>Pembayaran<br><span> Proses Pembayaran</span></h4>
              </li>
              <li>
                <img src="assets/images/info-icon-04.png" alt="" style="max-width: 52px;">
                <h4>Keamanan<br><span>24/7 Di Bawah Kendali</span></h4>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4 offset-lg-4">
          <div class="section-heading text-center">
            <h6>| Video View</h6>
            <h2>Dapatkan Pandangan Lebih Dekat & Perasaan Berbeda</h2>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="counter">
                  <h2 class="timer count-title count-number" data-to="34" data-speed="1000"></h2>
                   <p class="count-text ">Bangunan<br>Selesai Sekarang</p>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="counter">
              ...
              <div class="col-lg-4">
                <div class="counter">
                  ...
                  <p class="count-text ">Berdiri<br>Tahun 2023</p>
                </div>
              </div>
            </div>
          </div>
